...
restaurant24 = Restaurant.create(name: "Lombardi's", neighborhood: "NoLita", borough: "Manhattan", seating: "tables available", category_ids: ["10"], multiple_locations: "true", oven: "Coal"),
...
restaurant50 = Restaurant.create(name: "Two Boots", neighborhood: "East Village", borough: "Manhattan", seating: "tables available", category_ids: ["2"], multiple_locations: "true"),
restaurant51 = Restaurant.create(name: "Una Pizza Napoletana", neighborhood: "Lower East Side", borough: "Manhattan", seating: "tables available", category_ids: ["10"]),
restaurant52 = Restaurant.create(name: "Upside Pizza", neighborhood: "Midtown West", borough: "Manhattan", seating: "tables available", category_ids: ["12", "16"], oven: "Gas"),
restaurant53 = Restaurant.create(name: "Zero Otto Nove", neighborhood: "Belmont", borough: "Queens", seating: "tables available", category_ids: ["10"], multiple_locations: "true"),
...
pie2 = Pie.create(name: "Bandiera Square", category_id: "16", cheese_ids: ["11", "25"], sauce_id: "15", crust_id: "5", topping_ids: ["112", "46"], restaurant_ids: ["41"]),
pie3 = Pie.create(name: "Burrata", category_id: "10", cheese_ids: ["3"], sauce_id: "9", crust_id: "5", topping_ids: ["25", "43", "104"], restaurant_ids: ["48"]),
...
pie6 = Pie.create(name: "Cheese", category_id: "2", cheese_ids: ["19"], sauce_id: "15", crust_id: "2", topping_ids: ["1"], restaurant_ids: ["50"]),
...
pie9 = Pie.create(name: "Cheese", category_id: "10", cheese_ids: ["19"], sauce_id: "15", crust_id: "5", topping_ids: ["1"], restaurant_ids: ["7", "18", "44"]),
pie10 = Pie.create(name: "Cheese", category_id: "10", cheese_ids: ["19", "14", "21"], sauce_id: "15", crust_id: "6", topping_ids: ["1"], restaurant_ids: ["17"]),
pie11 = Pie.create(name: "Cheese Square", category_id: "16", cheese_ids: ["11", "21", "22"], sauce_id: "15", crust_id: "5", topping_ids: ["1"], restaurant_ids: ["41"]),
pie12 = Pie.create(name: "Cherrystone Clam", category_id: "18", cheese_ids: ["10"], sauce_id: "9", crust_id: "5", topping_ids: ["45", "72", "73", "61", "39"], restaurant_ids: ["30"]),
pie13 = Pie.create(name: "Cherry Jones", category_id: "10", cheese_ids: ["11", "13"], sauce_id: "9", crust_id: "5", topping_ids: ["90", "34", "70"], restaurant_ids: ["32"]),
pie14 = Pie.create(name: "Clam", category_id: "18", cheese_ids: ["1"], sauce_id: "9", crust_id: "5", topping_ids: ["31", "39", "45", "73"], restaurant_ids: ["11", "23"]),
...
pie17 = Pie.create(name: "Doc", category_id: "10", cheese_ids: ["2"], sauce_id: "15", crust_id: "5", topping_ids: ["43"], restaurant_ids: ["37"]),
pie18 = Pie.create(name: "Famous Original", category_id: "10", cheese_ids: ["19", "4", "21"], sauce_id: "15", crust_id: "5", topping_ids: ["71", "27"], restaurant_ids: ["42"]),
pie19 = Pie.create(name: "Filetti", category_id: "10", cheese_ids: ["2"], sauce_id: "9", crust_id: "5", topping_ids: ["25", "46", "43"], restaurant_ids: ["51"])
...
pie21 = Pie.create(name: "Grandma", category_id: "7", cheese_ids: ["19", "22"], sauce_id: "15", crust_id: "5", topping_ids: ["46"], restaurant_ids: ["8", "16", "31"]),
pie22 = Pie.create(name: "Grandma Josie", category_id: "7", cheese_ids: ["11"], sauce_id: "12", crust_id: "5", topping_ids: ["43"], restaurant_ids: ["34", "35"]),
pie23 = Pie.create(name: "Hellboy", category_id: "10", cheese_ids: ["11", "21"], sauce_id: "12", crust_id: "5", topping_ids: ["109", "65"], restaurant_ids: ["32"]),
pie24 = Pie.create(name: "Hometown Briskey", category_id: "10", cheese_ids: ["11"], sauce_id: "9", crust_id: "5", topping_ids: ["12", "84", "10"], restaurant_ids: ["32"]),
pie25 = Pie.create(name: "In Ricotta Da Vegan", category_id: "10", cheese_ids: ["5"], sauce_id: "17", crust_id: "5", topping_ids: ["124", "6", "39"], restaurant_ids: ["32"]),
pie26 = Pie.create(name: "Jimmy Snuka", category_id: "10", cheese_ids: ["11"], sauce_id: "15", crust_id: "5", topping_ids: ["85", "57", "110"], restaurant_ids: ["29"]),
pie27 = Pie.create(name: "l'Originale", category_id: "14", cheese_ids: ["19"], sauce_id: "15", crust_id: "1", topping_ids: ["71"], restaurant_ids: ["1"]),
pie28 = Pie.create(name: "Littleneck Clam", category_id: "10", cheese_ids: ["1"], sauce_id: "9", crust_id: "5", topping_ids: ["45", "46", "61", "20", "32"], restaurant_ids: ["36"]),
pie29 = Pie.create(name: "Margherita", category_id: "13", cheese_ids: ["2"], sauce_id: "12", crust_id: "5", topping_ids: ["43"], restaurant_ids: ["36", "51"]),
pie30 = Pie.create(name: "Margherita", category_id: "13", cheese_ids: ["11"], sauce_id: "8", crust_id: "1", topping_ids: ["43"], restaurant_ids: ["30", "46"]),
pie31 = Pie.create(name: "Margherita", category_id: "13", cheese_ids: ["11"], sauce_id: "8", crust_id: "5", topping_ids: ["43"], restaurant_ids: ["11", "15", "18", "20", "21", "24", "26", "28", "32", "33", "42", "43", "48", "49"]),
pie32 = Pie.create(name: "Margherita", category_id: "13", cheese_ids: ["11"], sauce_id: "12", crust_id: "8", topping_ids: ["43", "71", "27"], restaurant_ids: ["47"]),
...
pie34 = Pie.create(name: "Margherita", category_id: "13", cheese_ids: ["10", "21"], sauce_id: "15", crust_id: "5", topping_ids: ["43", "39", "104"], restaurant_ids: ["30"]),
pie35 = Pie.create(name: "Margherita", category_id: "7", cheese_ids: ["11"], sauce_id: "8", crust_id: "5", topping_ids: ["43", "39"], restaurant_ids: ["38"]),
pie36 = Pie.create(name: "Margherita", category_id: "13", cheese_ids: ["11", "20"], sauce_id: "15", crust_id: "5", topping_ids: ["43"], restaurant_ids: ["53"]),
pie37 = Pie.create(name: "Margherita Vodka", category_id: "13", cheese_ids: ["11"], sauce_id: "18", crust_id: "5", topping_ids: ["1"], restaurant_ids: ["37"]),
pie38 = Pie.create(name: "Marinara", category_id: "10", cheese_ids: ["1"], sauce_id: "15", crust_id: "5", topping_ids: ["46", "71"], restaurant_ids: ["20",  "32"]),
pie39 = Pie.create(name: "Marinara", category_id: "10", cheese_ids: ["1"], sauce_id: "15", crust_id: "5", topping_ids: ["43", "46", "71"], restaurant_ids: ["40", "51"]),
pie40 = Pie.create(name: "Marinara", category_id: "10", cheese_ids: ["1"], sauce_id: "15", crust_id: "5", topping_ids: ["71", "46", "104", "39"], restaurant_ids: ["6", "23", "30"]),
pie41 = Pie.create(name: "Marinara", category_id: "10", cheese_ids: ["1"], sauce_id: "12", crust_id: "8", topping_ids: ["3", "43", "71", "27", "104"], restaurant_ids: ["47"]),
pie42 = Pie.create(name: "Marinara", category_id: "10", cheese_ids: ["11"], sauce_id: "15", crust_id: "5", topping_ids: ["71", "43", "46", "23", "3", "68"], restaurant_ids: ["53"]),
pie43 = Pie.create(name: "Meatball", category_id: "10", cheese_ids: ["10", "21"], sauce_id: "15", crust_id: "5", topping_ids: ["64", "43"], restaurant_ids: ["30"]),
...
pie46 = Pie.create(name: "Pepperoni", category_id: "6", cheese_ids: ["19", "21"], sauce_id: "15", crust_id: "5", topping_ids: ["77", "44"], restaurant_ids: ["27"]),
pie47 = Pie.create(name: "Pepperoni", category_id: "8", cheese_ids: ["19"], sauce_id: "15", crust_id: "5", topping_ids: ["77"], restaurant_ids: ["4"]),
pie48 = Pie.create(name: "Pepperoni", category_id: "12", cheese_ids: ["19"], sauce_id: "15", crust_id: "5", topping_ids: ["77"], restaurant_ids: ["19", "39",  "45", "52"]),
pie49 = Pie.create(name: "Pepperoni", category_id: "10", cheese_ids: ["19"], sauce_id: "15", crust_id: "6", topping_ids: ["77", "55"], restaurant_ids: ["17"]),
pie50 = Pie.create(name: "Plain", category_id: "12", cheese_ids: ["19"], sauce_id: "15", crust_id: "5", topping_ids: ["1"], restaurant_ids: ["2", "8", "9", "16", "19", "23", "25", "31", "39", "43", "45", "52"]),
pie51 = Pie.create(name: "Plain", category_id: "10", cheese_ids: ["2", "21"], sauce_id: "15", crust_id: "5", topping_ids: ["1"], restaurant_ids: ["16"] ),
pie52 = Pie.create(name: "Prince Perfection", category_id: "16", cheese_ids: ["11", "22"], sauce_id: "12", crust_id: "5", topping_ids: ["39"], restaurant_ids: ["38"]),
pie53 = Pie.create(name: "Queen", category_id: "10", cheese_ids: ["11", "22"], sauce_id: "15", crust_id: "5", topping_ids: ["43"], restaurant_ids: ["29"]),
pie54 = Pie.create(name: "Red", category_id: "10", cheese_ids: ["14", "22"], sauce_id: "15", crust_id: "6", topping_ids: ["1"], restaurant_ids: ["17"]),
pie55 = Pie.create(name: "Red Planet", category_id: "6", cheese_ids: ["1"], sauce_id: "5", crust_id: "5", topping_ids: ["71", "46", "43"], restaurant_ids: ["13", "14"]),
pie56 = Pie.create(name: "Regular", category_id: "10", cheese_ids: ["14", "19", "21"], sauce_id: "12", crust_id: "5", topping_ids: ["43"], restaurant_ids: ["12"]),
pie57 = Pie.create(name: "Rosso", category_id: "10", cheese_ids: ["1"], sauce_id: "13", crust_id: "7", topping_ids: ["71", "46"], restaurant_ids: ["39"]),
pie58 = Pie.create(name: "Rosso", category_id: "10", cheese_ids: ["1"], sauce_id: "13", crust_id: "5", topping_ids: ["59", "43", "67", "27"], restaurant_ids: ["9"]),
pie59 = Pie.create(name: "Rubirosa Supreme", category_id: "10", cheese_ids: ["11"], sauce_id: "15", crust_id: "5", topping_ids: ["77", "64", "93"], restaurant_ids: ["44"]),
pie60 = Pie.create(name: "Sicilian", category_id: "16", cheese_ids: ["19", "22"], sauce_id: "15", crust_id: "5", topping_ids: ["1"], restaurant_ids: ["2", "8", "18", "19", "22", "31", "38", "44"]),
pie61 = Pie.create(name: "Spicy Spring", category_id: "16", cheese_ids: ["11"], sauce_id: "6", crust_id: "5", topping_ids: ["77"], restaurant_ids: ["38"]),
pie62 = Pie.create(name: "Square", category_id: "10", cheese_ids: ["11"], sauce_id: "15", crust_id: "5", topping_ids: ["43", "68", "71"], restaurant_ids: ["32"]),
pie63 = Pie.create(name: "St. Louie", category_id: "10", cheese_ids: ["23"], sauce_id: "12", crust_id: "8", topping_ids: ["97", "77", "81"], restaurant_ids: ["47"]),
pie64 = Pie.create(name: "Tomato", category_id: "7", cheese_ids: ["22", "14"], sauce_id: "15", crust_id: "1", topping_ids: ["46", "71"], restaurant_ids: ["10"]),
pie65 = Pie.create(name: "Upside Pep", category_id: "16", cheese_ids: ["11"], sauce_id: "15", crust_id: "1", topping_ids: ["77"], restaurant_ids: ["52"]),
pie66 = Pie.create(name: "Vodka", category_id: "6", cheese_ids: ["11", "25"], sauce_id: "18", crust_id: "5", topping_ids: ["43"], restaurant_ids: ["27"]),
pie67 = Pie.create(name: "Vodka", category_id: "10", cheese_ids: ["11"], sauce_id: "18", crust_id: "5", topping_ids: ["43"], restaurant_ids: ["18"]),
pie68 = Pie.create(name: "Vodka", category_id: "6", cheese_ids: ["11"], sauce_id: "18", crust_id: "5", topping_ids: ["1"], restaurant_ids: ["13", "14"]),
pie69 = Pie.create(name: "Vodka", category_id: "10", cheese_ids: ["11"], sauce_id: "18", crust_id: "5", topping_ids: ["1"], restaurant_ids: ["41"]),
pie70 = Pie.create(name: "White", category_id: "7", cheese_ids: ["11", "25", "14", "22"], sauce_id: "9", crust_id: "5", topping_ids: ["15"], restaurant_ids: ["10"]),
pie71 = Pie.create(name: "White", category_id: "10", cheese_ids: ["11", "24", "21"], sauce_id: "9", crust_id: "5", topping_ids: ["46", "43"], restaurant_ids: ["15", "24", "31"]),
pie72 = Pie.create(name: "White", category_id: "10", cheese_ids: ["11"], sauce_id: "9", crust_id: "5", topping_ids: ["46"], restaurant_ids: ["20"]),
pie73 = Pie.create(name: "White", category_id: "10", cheese_ids: ["11", "21"], sauce_id: "9", crust_id: "5", topping_ids: ["24", "66"], restaurant_ids: ["7"])
