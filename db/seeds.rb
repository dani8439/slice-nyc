...
top70 = Topping.create(name: "Oreganata Butter"),
top71 = Topping.create(name: "Parsley"),
top72 = Topping.create(name: "Pastrami"),
top73 = Topping.create(name: "Pear Tomatoes"),
top74 = Topping.create(name: "Pepperoncini"),
top75 = Topping.create(name: "Pepperoni"),
top76 = Topping.create(name: "Peppers"),
top77 = Topping.create(name: "Pesto"),
top78 = Topping.create(name: "Pickled Chilies"),
top79 = Topping.create(name: "Pickled Jalapeño"),
top80 = Topping.create(name: "Pickled Pineapple"),
top81 = Topping.create(name: "Pickled Red Grapes"),
top82 = Topping.create(name: "Pickled Red Onions"),
top83 = Topping.create(name: "Pineapple"),
top84 = Topping.create(name: "Pistachio"),
top85 = Topping.create(name: "Potatoes"),
top86 = Topping.create(name: "Porcini Mushrooms"),
top87 = Topping.create(name: "Primo sale"),
top88 = Topping.create(name: "Prosciutto di Parma"),
top89 = Topping.create(name: "Ranch"),
top90 = Topping.create(name: "Red Onion"),
top91 = Topping.create(name: "Roasted Garlic"),
top92 = Topping.create(name: "Roast Pork"),
top93 = Topping.create(name: "Sake reduction and Heavy cream"),
top94 = Topping.create(name: "Salt Cured Olives"),
top95 = Topping.create(name: "Sauerkraut"),
top96 = Topping.create(name: "Sausage"),
top97 = Topping.create(name: "Sautéed Broccoli Rabe"),
top98 = Topping.create(name: "Sautéed Garlic Spinach"),
top99 = Topping.create(name: "Sautéed Onion & Pepper"),
top100 = Topping.create(name: "Sautéed Spinach"),
top101 = Topping.create(name: "Scallions"),
top102 = Topping.create(name: "Sea Salt"),
top103 = Topping.create(name: "Seasonal Greens"),
top104 = Topping.create(name: "Smoked Pancetta"),
top105 = Topping.create(name: "Soppressata"),
top106 = Topping.create(name: "Soppressata Picante"),
top107 = Topping.create(name: "Speck"),
top108 = Topping.create(name: "Spicy Salami"),
top109 = Topping.create(name: "Spinach"),
top110 = Topping.create(name: "Sun-Dried Tomatoes"),
top111 = Topping.create(name: "Sweet Italian fennel sausage"),
top112 = Topping.create(name: "Sweet Roasted Red Peppers"),
top113 = Topping.create(name: "Sweet Sausage"),
top114 = Topping.create(name: "Szechuan Oil"),
top115 = Topping.create(name: "Thyme"),
top116 = Topping.create(name: "Tomato"),
top117 = Topping.create(name: "Truffle Oil"),
top118 = Topping.create(name: "Truffle Pate"),
top119 = Topping.create(name: "Vegan meatballs"),
top120 = Topping.create(name: "Vegan sausage"),
top121 = Topping.create(name: "White Anchovies"),
top122 = Topping.create(name: "White Balsamic"),

pie1 = Pie.create(name: "Cacio e Pepe", category_id: "14", cheese_ids: ["18", "21"], sauce_id: "13", crust_id: "1", topping_ids: ["16", "117"], restaurant_ids: ["1"]),
...
pie4 = Pie.create(name: "Cheese", category_id: "10", cheese_ids: ["18"], sauce_id: "13", crust_id: "4", topping_ids: ["1"], restaurant_ids: ["17"]),
pie5 = Pie.create(name: "Cherrystone Clam", category_id: "18", cheese_ids: ["10"], sauce_id: "7", crust_id: "4", topping_ids: ["43", "70", "71", "59", "37"], restaurant_ids: ["28"]),
pie = Pie.create(name: "Cherry Jones", category_id: "10", cheese_ids: ["11", "13"], sauce_id: "7", crust_id: "4", topping_ids: ["88", "32", "68"], restaurant_ids: ["32"]),
pie6 = Pie.create(name: "Clam", category_id: "18", cheese_ids: ["1"], sauce_id: "7", crust_id: "4", topping_ids: ["30", "37", "43", "71"], restaurant_ids: ["10"]),
pie7 = Pie.create(name: "Famous Original", category_id: "10", cheese_ids: ["18", "4", "20"], sauce_id: "13", crust_id: "4", topping_ids: ["69", "26"], restaurant_ids: ["39"]),
pie8 = Pie.create(name: "Garbage", category_id: "10", cheese_ids: ["18"], sauce_id: "13", crust_id: "4", topping_ids: ["95", "62", "67", "64", "44"], restaurant_ids: ["10"]),
pie9 = Pie.create(name: "Grandma", category_id: "7", cheese_ids: ["18", "21"], sauce_id: "13", crust_id: "4", topping_ids: ["44"], restaurant_ids: ["29"]),
pie = Pie.create(name: "Hellboy", category_id: "10", cheese_ids: ["11", "20"], sauce_id: "10", crust_id: "4", topping_ids: ["106", "63"], restaurant_ids: ["32"]),
pie = PIe.create(name: "Hometown Briskey", category_id: "10", cheese_ids: ["11"], sauce_id: "7", crust_id: "4", topping_ids: ["12", "82", "10"], restaurant_ids: ["32"]),
pie = Pie.create(name: "In Ricotta Da Vegan", category_id: "10", cheese_ids: ["5"], sauce_id: "15", crust_id: "4", topping_ids: ["120", "6", "37"], restaurant_ids: ["32"]),
pie10 = Pie.create(name: "l'Originale", category_id: "14", cheese_ids: ["18"], sauce_id: "13", crust_id: "1", topping_ids: ["69"], restaurant_ids: ["1"]),
pie11 = Pie.create(name: "Margherita", category_id: "13", cheese_ids: ["11"], sauce_id: "6", crust_id: "1", topping_ids: ["41"], restaurant_ids: ["30", "43"]),
pie12 = Pie.create(name: "Margherita", category_id: "13", cheese_ids: ["11"], sauce_id: "6", crust_id: "4", topping_ids: ["41"], restaurant_ids: ["10", "17", "19", "22", "24", "26", "30", "31", "39", "46"]),
pie13 = Pie.create(name: "Margherita", category_id: "13", cheese_ids: ["11"], sauce_id: "10", crust_id: "7", topping_ids: ["41", "69", "26"], restaurant_ids: ["44"]),
pie14 = Pie.create(name: "Margherita", category_id: "13", cheese_ids: ["10", "21"], sauce_id: "13", crust_id: "4", topping_ids: ["41", "37", "102"], restaurant_ids: ["28"]),
pie15 = Pie.create(name: "Margherita", category_id: "7", cheese_ids: ["11"], sauce_id: "6", crust_id: "4", topping_ids: ["41", "37"], restaurant_ids: ["35"]),
pie16 = Pie.create(name: "Marinara", category_id: "10", cheese_ids: ["1"], sauce_id: "13", crust_id: "4", topping_ids: ["44", "69"], restaurant_ids: ["19",  "30"]),
pie17 = Pie.create(name: "Marinara", category_id: "10", cheese_ids: ["1"], sauce_id: "13", crust_id: "4", topping_ids: ["69", "44", "102", "37"], restaurant_ids: ["28"]),
pie18 = Pie.create(name: "Marinara", category_id: "10", cheese_ids: ["1"], sauce_id: "10", crust_id: "7", topping_ids: ["3", "41", "69", "26", "102"], restaurant_ids: ["44"]),
pie19 = Pie.create(name: "Meatball", category_id: "10", cheese_ids: ["10", "20"], sauce_id: "13", crust_id: "4", topping_ids: ["62", "41"], restaurant_ids: ["28"]),
pie20 = Pie.create(name: "Pepperoni", category_id: "12", cheese_ids: ["18"], sauce_id: "13", crust_id: "4", topping_ids: ["75"], restaurant_ids: ["18", "42"]),
pie21 = Pie.create(name: "Pepperoni", category_id: "6", cheese_ids: ["18", "20"], sauce_id: "13", crust_id: "4", topping_ids: ["75", "41"], restaurant_ids: ["25"]),
pie22 = Pie.create(name: "Plain", category_id: "12", cheese_ids: ["18"], sauce_id: "13", crust_id: "4", topping_ids: ["1"], restaurant_ids: ["6", "18", "29", "42"]),
pie23 = Pie.create(name: "Plain", category_id: "10", cheese_ids: ["2", "20"], sauce_id: "13", crust_id: "4", topping_ids: ["1"], restaurant_ids: ["14"] ),
pie24 =  Pie.create(name: "Price Perfection", category_id: "16", cheese_ids: ["11", "21"], sauce_id: "11", crust_id: "4", topping_ids: ["37"], restaurant_ids: ["35"]),
pie25 = Pie.create(name: "Regular", category_id: "10", cheese_ids: ["14", "18", "20"], sauce_id: "10", crust_id: "4", topping_ids: ["41"], restaurant_ids: ["11"]),
pie26 = Pie.create(name: "Rosso", category_id: "10", cheese_ids: ["1"], sauce_id: "13", crust_id: "4", topping_ids: ["69", "44"], restaurant_ids: ["39"]),
pie27 = Pie.create(name: "Sicilian", category_id: "16", cheese_ids: ["18", "21"], sauce_id: "13", crust_id: "4", topping_ids: ["1"], restaurant_ids: ["17", "18", "29", "35"]),
pie28 = Pie.create(name: "Spicy Spring", category_id: "16", cheese_ids: ["11"], sauce_id: "4", crust_id: "4", topping_ids: ["75"], restaurant_ids: ["35"]),
pie29 = Pie.create(name: "Square", category_id: "10", cheese_ids: ["11"], sauce_id: "13", crust_id: "4", topping_ids: ["41", "66", "69"], restaurant_ids: ["30"]),
pie30 = Pie.create(name: "St. Louie", category_id: "10", cheese_ids: ["22"], sauce_id: "10", crust_id: "7", topping_ids: ["95", "75", "79"], restaurant_ids: ["44"]),
pie31 = Pie.create(name: "Tomato", category_id: "7", cheese_ids: ["21", "14"], sauce_id: "13", crust_id: "1", topping_ids: ["44", "69"], restaurant_ids: ["9"]),
pie32 = Pie.create(name: "Vodka", category_id: "6", cheese_ids: ["24"], sauce_id: "16", crust_id: "4", topping_ids: ["41"], restaurant_ids: ["25"]),
pie33 = Pie.create(name: "Vodka", category_id: "10", cheese_ids: ["11"], sauce_id: "16", crust_id: "4", topping_ids: ["41"], restaurant_ids: ["17"]),
pie34 = Pie.create(name: "White", category_id: "7", cheese_ids: ["17", "24", "14", "21"], sauce_id: "7", crust_id: "4", topping_ids: ["15"], restaurant_ids: ["9"]),
pie35 = Pie.create(name: "White", category_id: "10", cheese_ids: ["11", "23", "20"], sauce_id: "7", crust_id: "4", topping_ids: ["44", "41"], restaurant_ids: ["14", "22", "29"]),
pie = Pie.create(name: "White", category_id: "10", cheese_ids: ["11"], sauce_id: "7", crust_id: "4", topping_ids: ["44"], restaurant_ids: ["19"])
