...
cheese5 = Cheese.create(name: "Cheddar"),
cheese6 = Cheese.create(name: "Cheddar Curds"),
cheese7 = Cheese.create(name: "Double Pecorino"),
cheese8 = Cheese.create(name: "Feta Cheese"),
cheese9 = Cheese.create(name: "Fior di Latte"),
cheese10 = Cheese.create(name: "Fresh Mozzarella"),
cheese11 = Cheese.create(name: "Goat"),
cheese12 = Cheese.create(name: "Gorgonzola"),
cheese13 = Cheese.create(name: "Gruyere"),
cheese14 = Cheese.create(name: "Havarti"),
cheese15 = Cheese.create(name: "Mild Gouda"),
cheese16 = Cheese.create(name: "Mozzarella"),
cheese17 = Cheese.create(name: "NUMU vegan Mozzarella"),
cheese18 = Cheese.create(name: "Parmigiana"),
cheese19 = Cheese.create(name: "Parmigiano Reggiano"),
cheese20 = Cheese.create(name: "Pecorino Romano"),
cheese21 = Cheese.create(name: "Provel"),
cheese22 = Cheese.create(name: "Ricotta"),
cheese23 = Cheese.create(name: "Sharp Provolone"),
cheese24 = Cheese.create(name: "Swiss"),
cheese25 = Cheese.create(name: "Trufﬂe Sottocenere"),
...
restaurant2 = Restaurant.create(name: "Archie's Bar & Pizza", neighborhood: "Bushwick", borough: "Broolyn", seating: "bar", category_ids: ["8"])
restaurant3 = Restaurant.create(name: "Barboncino", neighborhood: "Crown Heights", borough: "Brooklyn", seating: "tables available", category_ids: ["10"], oven: "Wood fire"),
restaurant4 = Restaurant.create(name: "Best Pizza", neighborhood: "Williamsburg", borough: "Brooklyn", seating: "Standing room only", category_ids: ["12"]),
restaurant5 = Restaurant.create(name: "Brother's Pizzeria", neighborhood: "Fresh Meadows", borough: "Queens", seating: "tables available", category_ids: ["12", "16"]),
restaurant6 = Restaurant.create(name: "Bruno Pizza", neighborhood: "East Village", borough: "Manhattan", seating: "tables available", category_ids: ["10"]),
restaurant7 = Restaurant.create(name: "Corner Slice at Gotham West", neighborhood: "Hell's Kitchen", borough: "Manhattan", seating: "tables available", category_ids: ["7"]),
restaurant8 = Restaurant.create(name: "Denino's", neighborhood: "Greenwich Village", borough: "Manhattan", seating: "tables available", category_ids: ["10"]),
restaurant9 = Restaurant.create(name: "Di Fara" , neighborhood: "Midwood", borough: "Brooklyn", seating: "limited seating", category_ids: ["12"]),
...
restaurant11 = Restaurant.create(name: "Giuseppina's", neighborhood: "South Slope", borough: "Brooklyn", seating: "tables available", category_ids: ["10"], oven: "Brick "),
restaurant12 = Restaurant.create(name: "Gloria", neighborhood: "Forest Hills", borough: "Queens", seating: "tables available", category_ids: ["7", "10", "16"]),
restaurant13 = Restaurant.create(name: "Gristmill", neighborhood: "Park Slope", borough: "Brooklyn", seating: "tables available", category_ids: ["7", "10"], oven: "Wood fire"),
restaurant14 = Restaurant.create(name: "Joe & Pat's", neighborhood: "Castleton Corners", borough: "Staten Island", seating: "tables available", category_ids: ["10"], multiple_locations: "true" ),
restaurant15 = Restaurant.create(name: "Joe's Pizza", neighborhood: "West Village", borough: "Manhattan", seating: "standing room only", category_ids: ["12"], multiple_locations: "true"),
restaurant16 = Restaurant.create(name: "Juliana's", neighborhood: "Dumbo", borough: "Brooklyn", seating: "tables available", category_ids: ["12"], multiple_locations: "false", oven: "Coal"),
restaurant17 = Restaurant.create(name: "Kesté", neighborhood: "Financial District", borough: "Manhattan", seating: "tables available", category_ids: ["10"], multiple_locations: "true", oven: "Wood fire"),
restaurant18 = Restaurant.create(name: "L&B Spumoni Gardens", neighborhood: "Gravesend", borough: "Brooklyn", seating: "tables available", category_ids: ["16"]),
restaurant19 = Restaurant.create(name: "Lucali", neighborhood: "Carroll Gardens" , borough: "Brooklyn", seating: "tables available" , category_ids: ["10"]),
restaurant20 = Restaurant.create(name: "MAMA'S TOO!" , neighborhood: "Manhattan Valley" , borough: "Manhattan", seating: "tables available", category_ids: ["6"]),
restaurant21 = Restaurant.create(name: "Mario's", neighborhood: "Belmont", borough: "Queens", seating: "tables available", category_ids: ["10"]),
restaurant22 = Restaurant.create(name: "Milkflower", neighborhood: "Astoria", borough: "Queens", seating: "tables available", category_ids: ["10"]),
restaurant23 = Restaurant.create(name: "Motorino" , neighborhood: "East Village" , borough: "Manhattan", seating: "limited tables", category_ids: ["10"] , multiple_locations: "true"),
restaurant24 = Restaurant.create(name: "NY Pizza Suprema", neighborhood: "Midtown", borough: "Manhattan", seating: "tables available" , category_ids: ["12"] ),
restaurant25 = Restaurant.create(name: "Ops", neighborhood: "Bushwick" , borough: "Brooklyn", seating: "tables available" , category_ids: ["10"], oven: "Brick oven"),
restaurant26 = Restaurant.create(name: "Patsy's Pizzeria", neighborhood: "East Harlem" , borough: "Manhattan" , seating: "tables available", category_ids: ["10"], oven: "Coal oven"),
restaurant27 = Restaurant.create(name: "Paulie Gee's", neighborhood:  "Greenpoint", borough: "Brooklyn" , seating: "tables available", category_ids: ["10"], multiple_locations: "true" ),
restaurant28 = Restaurant.create(name: "Pasquale Jones", neighborhood: "Little Italy", borough: "Manhattan", seating: "tables available", category_ids: ["10", "18"], oven: "Wood fire"),
restaurant29 = Restaurant.create(name: "Prince Street Pizza", neighborhood: "Nolita" , borough: "Manhattan" , seating: "limited seating", category_ids: ["7","16"]),
restaurant30 = Restaurant.create(name: "Ribalta", neighborhood: "Union Square", borough: "Manhattan", seating: "tables available", category_ids: ["10"]),
restaurant31 = Restaurant.create(name: "Roberta's", neighborhood: "Bushwick", borough: "Brooklyn" , seating: "tables available", category_ids: ["10"]),
restaurant32 = Restaurant.create(name: "Rosa's", neighborhood: "Maspeth", borough: "Queens", seating: "tables available", category_ids: ["14"]),
restaurant33 = Restaurant.create(name: "Rubirosa", neighborhood: "Nolita", borough: "Manhattan", seating: "tables available", category_ids: ["12"]),
restaurant34 = Restaurant.create(name: "Sal and Carmines", neighborhood: "Manhattan Valley", borough: "Manhattan", seating: "tables available", category_ids: ["12"] ),
restaurant35 = Restaurant.create(name: "Santa Panza", neighborhood: "Bushwick", borough: "Brooklyn", seating: "tables available", category_ids: ["10"], oven: "Wood fire"),
restaurant36 = Restaurant.create(name: "Speedy Romeo" , neighborhood: "Clinton Hill" , borough: "Brooklyn", seating: "tables available" , category_ids: ["17"], multiple_locations: "true" ),
restaurant37 = Restaurant.create(name: "Sottocasa", neighborhood: "Harlem", borough: "Manhattan", seating: "tables available", category_ids: ["10"], multiple_locations: "true"),
restaurant38 = Restaurant.create(name: "Totonno's" , neighborhood: "Coney Island" , borough: "Brooklyn", seating: "tables available", category_ids: ["13"]),
restaurant39 = Restaurant.create(name: "Una Pizza Napoletana", neighborhood: "Lower East Side", borough: "Manhattan", seating: "tables available", category_ids: ["10"]),
restaurant40 = Restaurant.create(name: "Zero Otto Nove", neighborhood: "Belmont", borough: "Queens", seating: "tables available", category_ids: ["10"], multiple_locations: "true"),
...
pie1 = Pie.create(name: "Plain", category_id: "9", cheese_ids: ["16"], sauce_id: "14", crust_id: "4", topping_ids: ["1"]),
pie2 = Pie.create(name: "Vodka", category_id: "4", cheese_ids: ["22"], sauce_id: "17", crust_id: "4", topping_ids: ["39"])
